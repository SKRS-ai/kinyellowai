  ...
  useEffect(() => {
    const fetchRegistryData = async () => {
      ...
      try {
        ...
        // DIAGNOSTIC LOG: Confirms exact column names from your Supabase table
              ...
              >
                <div>
                  ...
                  <p style={{ margin: '8px 0', fontSize: '11px', fontWeight: 'bold', color: '#666' }}>
                    {/* Handles NULL entity_type/jurisdiction in the Sony records */}
                  ...
                  <p style={{ fontSize: '15px', marginTop: '12px', maxWidth: '600px', lineHeight: '1.5' }}>
                    {/* Fallback for empty description fields */}
